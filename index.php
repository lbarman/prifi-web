  ...
  <body>
    <div id="corpus">
      <article class="markdown-body">
        ...
        <p>PriFi <?php addRef('prifi'); ?> is an <b>anonymous communication network</b>, developped at the EPFL and Yale University. It <b>protects your privacy</b> by preventing your employers, ISPs and the governements from tracking what you are doing on the Internet; more precisely, it hides the <i>source</i> of your communications. Conceptually close to Tor <?php addRef('tor'); ?>, PriFi aims to provide <b>lower latency and better anonymity</b>, and is tailored for WLANs and LANs.</p>
        <p>Get PriFi : <i class="code_snippet"><a href="https://www.github.com/lbarman/prifi">github.com/lbarman/prifi</a></i><img style="margin-left:10px" src="https://travis-ci.org/lbarman/prifi.svg?branch=master" alt="build status" class="githubbadge" /><img src="https://goreportcard.com/badge/github.com/lbarman/prifi" alt="go report card" class="githubbadge" /><img src='https://coveralls.io/repos/github/lbarman/prifi/badge.svg?branch=master' alt='Coverage Status' class="githubbadge" /></p>
